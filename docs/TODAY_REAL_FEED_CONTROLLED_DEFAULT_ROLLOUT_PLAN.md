...
This document is maintained through Phase 4 Task 33. It is planning-only.
...
Tasks 25 through 33 are only about making the pilot evidence easier to collect, update, review, report, and keep aligned with the current safety boundaries. The app still stays mock-by-default after these tasks.
