...
Phase 4 Task 37:
- continue the Today pilot only after capturing the still-missing evidence, especially a genuine `real_empty` observation and one completed, non-empty enriched-content win
