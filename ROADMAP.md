...
- design or guard the first AI-assisted enrichment step
- keep AI behind explicit server-side controls
- do not add AI until the real-content preview path is stable operationally
