...
Phase 4 Task 40:
- continue the Today pilot only after running `npm run phase4:today-evidence-next -- docs/evidence/today-real-feed-pilot-evidence.local.json` and capturing the next still-missing evidence item
