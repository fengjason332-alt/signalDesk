...
The next explicit rollout step after Task 26 is to run the actual operator pilot, fill the local evidence file, and review that evidence before any default-switch task is considered.
